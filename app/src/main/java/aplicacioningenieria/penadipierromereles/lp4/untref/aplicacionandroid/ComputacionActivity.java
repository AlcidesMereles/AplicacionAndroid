    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAmigos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ComputacionActivity.this, AmigosSonidoActivity.class);
        ...
        btnPadres.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ComputacionActivity.this, PadresSonidoActivity.class);
        ...
        btnNovia.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ComputacionActivity.this, NoviaSonidoActivity.class);
        ...
        btnRealidad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ComputacionActivity.this, RealidadSonidoActivity.class);
        ...
        btnRegresar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ComputacionActivity.this, MainActivity.class);
