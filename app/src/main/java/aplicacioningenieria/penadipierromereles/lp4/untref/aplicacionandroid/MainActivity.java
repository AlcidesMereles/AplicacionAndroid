...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Evento de CLick del boton Computacion
        ...
        //Evento de CLick del boton Sonido
        btnSonido.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Creo el intent para acceder a la Activity de Informatica
        ...
        //Evento de CLick del boton Salir
