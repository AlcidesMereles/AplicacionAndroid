...
public class PadresComputacionActivity extends ActionBarActivity {
    private Button btnRegresar;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_padres_computacion);
        ...
        btnRegresar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(PadresComputacionActivity.this, ComputacionActivity.class);
