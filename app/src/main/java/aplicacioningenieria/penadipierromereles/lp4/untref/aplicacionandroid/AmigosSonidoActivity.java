...
public class AmigosSonidoActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amigos_sonido);
        ...
        btnRegresar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AmigosSonidoActivity.this, SonidoActivity.class);
